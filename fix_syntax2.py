...
# Fix saveDraft
bad_save_draft = """                monthlyDayOfWeek = monthlyDayOfWeek,
,,,,,
                occurrenceCount = occurrenceCount"""

good_save_draft = """                monthlyDayOfWeek = monthlyDayOfWeek,
...
# Check finalDraft again
content = re.sub(r'monthlyDayOfWeek = monthlyDayOfWeek,, annuallyMonth = Calendar\.JANUARY, annuallyDates = emptySet\(\),, annuallyDayOfWeek = Calendar\.SUNDAY,', 'monthlyDayOfWeek = monthlyDayOfWeek,\n                            annuallyType = AnnuallyType.DATES, annuallyMonth = Calendar.JANUARY, annuallyDates = emptySet(),\n                            annuallyWeek = 1, annuallyDayOfWeek = Calendar.SUNDAY,', content)
