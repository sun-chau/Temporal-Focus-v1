                    ...
                    item {
                        ...
                        Box(
                            ...
                            Row(verticalAlignment = Alignment.CenterVertically) {
                                Icon(androidx.compose.material.icons.Icons.Default.NotInterested, contentDescription = "None", modifier = Modifier.size(16.dp).padding(end = 4.dp), tint = MaterialTheme.colorScheme.onSurfaceVariant)
                                Text(
                                    text = "None",
...
if old_lazy_row in content:
    ...
    print("Failed to replace lazy row in create screen")
    sys.exit(1)
